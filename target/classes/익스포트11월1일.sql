...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SCOTT"."SHOPPINGBASKET_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Table ADMIN
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into SCOTT.MEMBER (ID,PW,NAME,AGE,GENDER,P_NUMBER,EMAIL,ADDRESS,AUTHORITY,REGDATE,MODDATE) values ('admin0','pw0','admin0','30','man','010-000-0000','admon@gmail.com','USA','admin',to_date('23/11/01','RR/MM/DD'),to_date('23/11/01','RR/MM/DD'));
Insert into SCOTT.MEMBER (ID,PW,NAME,AGE,GENDER,P_NUMBER,EMAIL,ADDRESS,AUTHORITY,REGDATE,MODDATE) values ('user0','pw0','user0','24','woman','010-000-0000','user@gmail.com','서울 어딘가','user',to_date('23/11/01','RR/MM/DD'),to_date('23/11/01','RR/MM/DD'));
Insert into SCOTT.MEMBER (ID,PW,NAME,AGE,GENDER,P_NUMBER,EMAIL,ADDRESS,AUTHORITY,REGDATE,MODDATE) values ('user1','user1','user1','24','woman','010-111-1111','user1@user1.com','USA',null,to_date('23/11/01','RR/MM/DD'),to_date('23/11/01','RR/MM/DD'));
REM INSERTING into SCOTT.ORDERS
SET DEFINE OFF;
Insert into SCOTT.ORDERS (O_NO,O_ID,O_REGDATE) values (1,'user0',to_date('23/11/01','RR/MM/DD'));
...
SET DEFINE OFF;
Insert into SCOTT.SHOPPINGBASKET (B_NO,U_ID,P_NO,QUANTITY,B_REGDATE) values (1,'user0',5,2,to_date('23/11/01','RR/MM/DD'));
Insert into SCOTT.SHOPPINGBASKET (B_NO,U_ID,P_NO,QUANTITY,B_REGDATE) values (2,'user0',3,10,to_date('23/11/01','RR/MM/DD'));
