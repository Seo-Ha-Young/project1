...
SET DEFINE OFF;
Insert into SCOTT.PRODUCT (P_NO,P_NAME,P_TYPE,P_PRODUCER,P_SIZE,PRICE,P_CONTENT,STOCK,SALE,REGDATE) values (10,'세미정장(그레이)','5','모론',105,198000,null,100,'y',to_date('23/09/26','RR/MM/DD'));
...
Insert into SCOTT.PRODUCT (P_NO,P_NAME,P_TYPE,P_PRODUCER,P_SIZE,PRICE,P_CONTENT,STOCK,SALE,REGDATE) values (9,'여름용 반바지','2','모론',90,9900,null,100,'y',to_date('23/09/25','RR/MM/DD'));
REM INSERTING into SCOTT.PRODUCTIMAGE
SET DEFINE OFF;
Insert into SCOTT.PRODUCTIMAGE (UUID,UPLOADPATH,FILENAME,FILETYPE,P_NO) values ('3b7cde69-1752-4c6c-a1ad-239d373cc16d','2023\09\25','삼베반바지.jpg','1',9);
Insert into SCOTT.PRODUCTIMAGE (UUID,UPLOADPATH,FILENAME,FILETYPE,P_NO) values ('4909f9de-a5a7-4560-a74c-13cfdd7cc789','2023\09\25','정장세트((검정).JPG','1',1);
Insert into SCOTT.PRODUCTIMAGE (UUID,UPLOADPATH,FILENAME,FILETYPE,P_NO) values ('2543cfaf-a045-4e70-a8f9-a78adb94815d','2023\09\26','정장세트((검정).jpg','1',10);
REM INSERTING into SCOTT.SHOPPINGBASKET
SET DEFINE OFF;
Insert into SCOTT.SHOPPINGBASKET (B_NO,U_ID,P_NO,QUANTITY,B_REGDATE) values (2,'user0',9,10,to_date('23/09/22','RR/MM/DD'));
Insert into SCOTT.SHOPPINGBASKET (B_NO,U_ID,P_NO,QUANTITY,B_REGDATE) values (1,'user0',1,10,to_date('23/10/05','RR/MM/DD'));
