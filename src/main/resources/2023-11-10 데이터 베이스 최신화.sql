...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SCOTT"."PRODUCT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SHOPPINGBASKET_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SCOTT"."SHOPPINGBASKET_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Table ADMIN
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into SCOTT.ADMIN (A_ID,A_PW,A_NAME,A_P_NUMBER,A_EMAIL,A_AUTHORITY,AGE,GENDER,A_REGDATE,A_MODDATE) values ('admin0','pw0','admin0','010-000-0000','admon@gmail.com','admin','30','man',to_date('23/11/01','RR/MM/DD'),to_date('23/11/01','RR/MM/DD'));
Insert into SCOTT.ADMIN (A_ID,A_PW,A_NAME,A_P_NUMBER,A_EMAIL,A_AUTHORITY,AGE,GENDER,A_REGDATE,A_MODDATE) values ('admin0','pw0','admin0','010-000-0000','admon@gmail.com','admin','30','man',to_date('23/11/01','RR/MM/DD'),to_date('23/11/01','RR/MM/DD'));
REM INSERTING into SCOTT.MEMBER
SET DEFINE OFF;
Insert into SCOTT.MEMBER (ID,PW,NAME,AGE,GENDER,P_NUMBER,EMAIL,ADDRESS,AUTHORITY,REGDATE,MODDATE) values ('user0','$2a$10$k0zHsgbe0JpSVPBl4dhy1.VuYbt9CrXU/Be6pgiecaKmxERli1t7S','user0','32','woman','01034280442','user0@user0.com','user0주소','user',to_date('23/11/08','RR/MM/DD'),to_date('23/11/08','RR/MM/DD'));
Insert into SCOTT.MEMBER (ID,PW,NAME,AGE,GENDER,P_NUMBER,EMAIL,ADDRESS,AUTHORITY,REGDATE,MODDATE) values ('admin0','$2a$10$oFAvtqy9f1hRzhfQJNqLz.oGEhH0pjB52my8wWQp8kX92HcsNboye','admin0','23','man','01034246234','admin0@admin0.com','admin0주소','admin',to_date('23/11/08','RR/MM/DD'),to_date('23/11/08','RR/MM/DD'));
Insert into SCOTT.MEMBER (ID,PW,NAME,AGE,GENDER,P_NUMBER,EMAIL,ADDRESS,AUTHORITY,REGDATE,MODDATE) values ('user2','$2a$10$z0nfHOSqZs2V..BXfVwn9eYJgrN7GBQLC1bFSz03zplH5G19wekFa','user2','42','woman','0103334444','admin1@admin1.com','경상북도 경주시 황성동 황성로 15 121호','user',to_date('23/11/07','RR/MM/DD'),to_date('23/11/07','RR/MM/DD'));
Insert into SCOTT.MEMBER (ID,PW,NAME,AGE,GENDER,P_NUMBER,EMAIL,ADDRESS,AUTHORITY,REGDATE,MODDATE) values ('user1','$2a$10$hj2G1wudINXXt5BUhsz1tetv1rpy5fDK8Zkaihi2lEGTwSfW/zRmW','user1','21','man','01034280442','user1@user1.com','user1주소','user',to_date('23/11/08','RR/MM/DD'),to_date('23/11/08','RR/MM/DD'));
Insert into SCOTT.MEMBER (ID,PW,NAME,AGE,GENDER,P_NUMBER,EMAIL,ADDRESS,AUTHORITY,REGDATE,MODDATE) values ('admin1','$2a$10$Ih/ik.jw1MEtj62Bxx7rmunpDfoTm1GKusDD8dtb1P3FnKtpIx7u2','admin1','36','man','010-333-4444','admin1@admin1.com','경상북도 경주시 황성동 황성로 15 121호','admin',to_date('23/11/02','RR/MM/DD'),to_date('23/11/02','RR/MM/DD'));
Insert into SCOTT.MEMBER (ID,PW,NAME,AGE,GENDER,P_NUMBER,EMAIL,ADDRESS,AUTHORITY,REGDATE,MODDATE) values ('user3','$2a$10$HqPykJK4r6j3gQC4.Yn16eIVTto./AlDDN.w4giXxiFnVFx2qxEWK','user3','21','man','01082930174','user3@user3.com','user3주소','user',to_date('23/11/08','RR/MM/DD'),to_date('23/11/08','RR/MM/DD'));
REM INSERTING into SCOTT.ORDERS
SET DEFINE OFF;
REM INSERTING into SCOTT.PRODUCT
SET DEFINE OFF;
Insert into SCOTT.PRODUCT (P_NO,P_NAME,P_TYPE,P_PRODUCER,P_SIZE,PRICE,P_CONTENT,STOCK,SALE,REGDATE) values (4,'여름용 반바지','2','모론',95,9900,'바지',20,'y',to_date('23/11/01','RR/MM/DD'));
Insert into SCOTT.PRODUCT (P_NO,P_NAME,P_TYPE,P_PRODUCER,P_SIZE,PRICE,P_CONTENT,STOCK,SALE,REGDATE) values (2,'와이셔츠(그레이)','1','모른',100,19800,'와이셔츠. 그잡채',100,'y',to_date('23/11/01','RR/MM/DD'));
Insert into SCOTT.PRODUCT (P_NO,P_NAME,P_TYPE,P_PRODUCER,P_SIZE,PRICE,P_CONTENT,STOCK,SALE,REGDATE) values (3,'여름용 반바지','2','모론',95,9900,'바지',20,'y',to_date('23/11/01','RR/MM/DD'));
Insert into SCOTT.PRODUCT (P_NO,P_NAME,P_TYPE,P_PRODUCER,P_SIZE,PRICE,P_CONTENT,STOCK,SALE,REGDATE) values (5,'세미정장(그레이)','5','모른',90,198000,'정장',100,'y',to_date('23/11/01','RR/MM/DD'));
REM INSERTING into SCOTT.PRODUCTIMAGE
SET DEFINE OFF;
Insert into SCOTT.PRODUCTIMAGE (UUID,UPLOADPATH,FILENAME,FILETYPE,P_NO) values ('52469fb1-ac06-4726-a226-0f999d0629e0,52469fb1-ac06-4726-a226-0f999d0629e0','2023\11\01,2023\11\01','삼베반바지.jpg,삼베반바지.jpg','1',3);
Insert into SCOTT.PRODUCTIMAGE (UUID,UPLOADPATH,FILENAME,FILETYPE,P_NO) values ('52469fb1-ac06-4726-a226-0f999d0629e0','2023\11\01','삼베반바지.jpg','1',4);
Insert into SCOTT.PRODUCTIMAGE (UUID,UPLOADPATH,FILENAME,FILETYPE,P_NO) values ('b083b430-b57d-4454-92f3-9362e7b47588','2023\11\01','정장세트((검정).jpg','1',5);
REM INSERTING into SCOTT.SHOPPINGBASKET
SET DEFINE OFF;
Insert into SCOTT.SHOPPINGBASKET (B_NO,U_ID,P_NO,QUANTITY,B_REGDATE) values (24,'user0',4,1,to_date('23/11/08','RR/MM/DD'));
REM INSERTING into SCOTT.USERS
SET DEFINE OFF;
Insert into SCOTT.USERS (U_ID,U_PW,U_NAME,U_P_NUMBER,U_EMAIL,U_ADDRESS,AGE,GENDER,U_REGDATE,U_MODDATE) values ('user0','pw0','user0','010-000-0000','user@gmail.com','서울 어딘가','24','woman',to_date('23/11/01','RR/MM/DD'),to_date('23/11/01','RR/MM/DD'));
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SCOTT"."SYS_C007421" ON "SCOTT"."PRODUCT" ("P_NO") 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SCOTT"."SYS_C007429" ON "SCOTT"."USERS" ("U_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SCOTT"."SYS_C007437" ON "SCOTT"."MEMBER" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SCOTT"."SYS_C007443" ON "SCOTT"."ORDERS" ("O_NO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SCOTT"."SYS_C007446" ON "SCOTT"."SHOPPINGBASKET" ("B_NO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SCOTT"."ADMIN" MODIFY ("GENDER" NOT NULL ENABLE);
  ALTER TABLE "SCOTT"."ADMIN" MODIFY ("AGE" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "SCOTT"."MEMBER" MODIFY ("ADDRESS" NOT NULL ENABLE);
  ALTER TABLE "SCOTT"."MEMBER" MODIFY ("EMAIL" NOT NULL ENABLE);
  ALTER TABLE "SCOTT"."MEMBER" MODIFY ("P_NUMBER" NOT NULL ENABLE);
  ALTER TABLE "SCOTT"."MEMBER" MODIFY ("GENDER" NOT NULL ENABLE);
  ALTER TABLE "SCOTT"."MEMBER" MODIFY ("AGE" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SCOTT"."USERS" MODIFY ("GENDER" NOT NULL ENABLE);
  ALTER TABLE "SCOTT"."USERS" MODIFY ("AGE" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "SCOTT"."SHOPPINGBASKET" ADD CONSTRAINT "FK_MEMBER_ID" FOREIGN KEY ("U_ID")
	  REFERENCES "SCOTT"."MEMBER" ("ID") ENABLE;
